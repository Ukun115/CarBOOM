...
namespace
{
	...
	const Vector3 PLAYER1_RESPOS = { -10.0f,0.0f,-10.0f };		//リスポーン座標(左上)
	const Vector3 PLAYER2_RESPOS = { 10.0f,0.0f,-10.0f };		//リスポーン座標(右上)
	const Vector3 PLAYER3_RESPOS = { -10.0f,0.0f,10.0f };		//リスポーン座標(左下)
	const Vector3 PLAYER4_RESPOS = { 10.0f,0.0f,10.0f };		//リスポーン座標(右下)
